    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <div className="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a className="sidebar-brand brand-logo" href="index.html">COVID-19 Tracker</a>
          <a className="sidebar-brand brand-logo-mini pt-3" href="index.html">COVID-19 Tracker</a>
        </div>
        <ul className="nav">
